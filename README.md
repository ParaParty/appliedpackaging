...
release audit:     passed dependency metadata, source-synced release resources, asset contracts, client smoke screenshots, and dedicated server world-load evidence
