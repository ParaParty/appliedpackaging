...
- `scripts/test-release-self-tests.ps1` runs the docs-audit, release-readiness, release-plan, manifest, and bundle self-tests together without starting Minecraft.
