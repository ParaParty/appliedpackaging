...
## Third-Party Asset Exception

The following GUI assets contain or adapt Applied Energistics 2 high-version GUI pixels and are distributed under `LGPL-3.0-or-later`, not under the Applied Packaging All Rights Reserved terms above:
