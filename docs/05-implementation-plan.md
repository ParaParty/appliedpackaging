...
已实现：
  ...
  已编码 AE2 blank_pattern 通过客户端 tooltip hook 显示 package_pattern 内容，未编码 AE2 blank_pattern 保持原版 tooltip
...
待实现：
  ...
  packaged_processing_pattern 到 AE2 原版 encoded pattern 的完整迁移评估
