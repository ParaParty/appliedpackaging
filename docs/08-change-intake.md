...
2026-07-11 当前非 UI 功能基线已收尾；用户提供的高级样板终端最终视觉、base 与 sprite atlas 已完成接入并通过当前验证，其余正式 UI/模型/动画范围仍等待后续描述。
...
改客户端类或资源加载：运行 runClientSmoke，并检查 latest.log 与 11 张必需 client smoke 截图。
