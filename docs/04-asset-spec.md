...
```text
唯一 ScreenStyle 入口: assets/ae2/screens/appliedpackaging/advanced_pattern_terminal.json
...
ScreenStyle: assets/ae2/screens/appliedpackaging/advanced_pattern_terminal.json
